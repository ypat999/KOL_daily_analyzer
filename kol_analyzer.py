...
class KOLAnalyzer:
    ...
    def merge_investment_advice(self, bili_advice, wechat_advice):
        """使用DeepSeek合并B站和微信的投资建议"""
        print("\n" + "="*50)
        print("开始合并投资建议")
        print("="*50)
        ...
        # 检查是否有投资建议需要合并
        if not bili_advice and not wechat_advice:
        ...
        try:
            ...
            merged_advice = deepseek_summary(
                ...
                userprompt="以下是来自B站财经视频分析和微信公众号文章分析的投资建议，请综合分析并给出未来几天的综合投资建议，包括：\n1. 整体市场判断\n2. 重点行业/板块分析\n3. 具体投资策略\n4. 风险提示\n5. 综合建议\n\n请详细分析并给出专业建议：\n\n"
            )
    ...
    def run_all_tasks(self):
        ...
        # 合并投资建议
        merged_advice = self.merge_investment_advice(bili_advice, wechat_advice)
